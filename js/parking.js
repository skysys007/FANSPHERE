...
const PARKING_CONFIG = {
  ...
  LOTS: [
    {
      id: 'lot-e',
      name: 'Lot E, East Rutherford, NJ 07073, USA',
      lat: 40.8162,
      lng: -74.0772,
      maxCapacity: 2500,
      price: '$40',
    ...
    {
      id: 'prepaid-efg',
      name: 'Prepaid Parking - Lots E/F/G, 1 FANSPHERE Stadium Dr, East Rutherford, NJ 07073, USA',
      lat: 40.8168,
      lng: -74.0745,
      maxCapacity: 1200,
      price: 'Prepaid',
    ...
    {
      id: 'lot-f',
      name: 'Lot F, East Rutherford, NJ 07073, USA',
      lat: 40.8175,
      lng: -74.0745,
      maxCapacity: 3000,
      price: '$40',
    ...
    {
      id: 'lot-g17',
      name: 'Stadium Lot G-17, East Rutherford, NJ 07073, USA',
      lat: 40.816,
      lng: -74.0715,
      maxCapacity: 4500,
      price: '$40',
    ...
    {
      id: 'lot-h',
      name: 'Lot H, H, East Rutherford, NJ 07073, USA',
      lat: 40.815,
      lng: -74.07,
      maxCapacity: 1500,
      price: '$40',
    ...
    {
      id: 'lot-j',
      name: 'New Meadowlands Flea Market (Lot J), Lot J FANSPHERE Stadium, 102 NJ-120, East Rutherford, NJ 07073, USA',
      lat: 40.8095,
      lng: -74.074,
      maxCapacity: 1500,
      price: '$60',
    ...
    {
      id: 'lot-k',
      name: 'Lot K, K, 1 American Way Level 2, Court C, East Rutherford, NJ 07073, USA',
      lat: 40.809,
      lng: -74.0725,
      maxCapacity: 1600,
      price: '$40',
    ...
    {
      id: 'lot-l',
      name: 'Lot L, East Rutherford, NJ 07073, USA',
      lat: 40.8105,
      lng: -74.071,
      maxCapacity: 800,
      price: '$120',
    ...
    {
      id: 'lot-m',
      name: 'Lot M, East Rutherford, NJ 07073, USA',
      lat: 40.8125,
      lng: -74.079,
      maxCapacity: 2100,
      price: '$40',
    ...
    {
      id: 'lot-p',
      name: 'Lot P, East Rutherford, NJ 07073, USA',
      lat: 40.811,
      lng: -74.078,
      maxCapacity: 1900,
      price: '$40',
    ...
    {
      id: 'lot-d',
      name: 'Lot D, 102 NJ-120, East Rutherford, NJ 07073, USA',
      lat: 40.813,
      lng: -74.0695,
      maxCapacity: 1800,
      price: '$40',
    ...
    {
      id: 'deck-bc',
      name: 'Parking Deck B/C, East Rutherford, NJ 07073, USA',
      lat: 40.8145,
      lng: -74.0685,
      maxCapacity: 2200,
      price: '$40',
    ...
    {
      id: 'ad-deck-d',
      name: 'American Dream Parking Deck D Gold, 1 American Dream Wy, East Rutherford, NJ 07073, USA',
      lat: 40.8075,
      lng: -74.067,
      maxCapacity: 3500,
      price: '$60',
    ...
    {
      id: 'redds',
      name: "Redd's Restaurant Parking, 317 Washington Ave, Carlstadt, NJ 07072, USA",
      lat: 40.82,
      lng: -74.085,
      maxCapacity: 200,
      price: '$30',
...
class StadiumParkingManager {
  ...
  focusLot(id) {
    ...
    if (markerObj && markerObj.el) {
      ...
      setTimeout(
        () => markerObj.el.classList.remove('animate-bounce'),
        PARKING_CONFIG.ANIMATION_DURATION_MS
      );
    }
  }
}
