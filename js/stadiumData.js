...
const RAG_DATABASE = [
  {
    ...
    content:
      'Gate 1 is located on the North side of the stadium. It is adjacent to Parking Lot A and the Taxi Drop-off zone. This gate is fully equipped with wheelchair-accessible ramps, elevators, and dedicated wide gates for disabled access.',
  ...
  },
  {
    ...
    content:
      'Gate 2 is on the East side of the stadium, closest to the Metro Station Subway Line 1. It experiences high crowd density during peak hours (1-2 hours before kickoff). Staff suggest utilizing Gate 1 or Gate 3 if Gate 2 queues exceed 20 minutes.',
  ...
  },
  {
    ...
    content:
      'Gate 3 is on the South side. It is the primary terminal for shuttle buses connecting to downtown hotels. It features wheelchair accessibility and a fast-track security lane for families.',
  ...
  },
  {
    ...
    content:
      'Gate 4 is on the West side of the stadium. It is dedicated to Media and VIP ticket holders. General admission is allowed but priority is given to credentials.',
  ...
  },
  {
    ...
    content:
      'Restroom North is a state-of-the-art all-gender, fully wheelchair-accessible restroom. It includes baby changing tables and emergency help chords. Restroom South is standard male/female facilities, but has support rails. Hand washing stations are touchless.',
  ...
  },
  {
    ...
    content:
      'EcoEats is our flagship sustainability food court located at the North Concourse. It serves 100% plant-based food in compostable packaging. Fans receive a 15% discount when returning cup containers to automated recycling bins nearby. Menu features vegan burgers, tacos, and organic local fruit bowls.',
    keywords: [
      'food',
      'concession',
      'eat',
  ...
  },
  {
    ...
    content:
      'The First Aid Station is located in the central concourse ring next to the main stadium administrative office. It is staffed 24/7 during matches with certified paramedics and has direct ambulance runway access. Call 911 or alert nearest steward in case of a medical emergency.',
    keywords: [
      'first aid',
      'doctor',
      'medical',
  ...
  },
  {
    ...
    content:
      'Kickoff is scheduled for 8:00 PM local time. Outer gates open at 5:00 PM. Fans are strongly encouraged to arrive before 6:30 PM to complete security screening and enjoy the pre-match light show. Closing ceremonies start 15 minutes after final whistle.',
  ...
  },
  {
    ...
    content:
      "Subway Line 1 runs directly to 'Stadium East Station' near Gate 2. Trains run every 3 minutes starting 3 hours before kickoff, and will run every 2 minutes for 2 hours post-match. Public transport tickets are free when bundled with a valid match day FIFA ticket.",
  ...
  },
  {
    ...
    content:
      'SmartStadium provides voice-guided navigation for visually impaired fans and step-free routing for wheelchair users. To use wheelchair-friendly routing, enable the wheelchair icon on the navigation panel. Accessible elevators are located at the North and South Concourse sectors.',
    keywords: [
      'wheelchair',
      'disabled',
      'accessible',
...
export { RAG_DATABASE, SUSTAINABILITY_METRICS, TRANSIT_SCHEDULE, FOOD_STALLS, TRANSLATIONS };
