  ...
  const interval = setInterval(() => {
    ...
    const payload = {
      ...
      sections: [
        ...
        { id: 'sec-132', occupancyRate: foodCourtOccupancy, movementSpeed: movementSpeed.toFixed(2) },
        { id: 'sec-215', occupancyRate: foodCourtOccupancy, movementSpeed: movementSpeed.toFixed(2) }
      ]
    };
