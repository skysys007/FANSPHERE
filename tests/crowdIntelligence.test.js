    ...
    const mockState = {
      ...
      sections: [
        ...
        },
        {
          ...
          capacity: 500,
          occupiedSeats: 25,
          peopleEnteringPerMin: 10,
          peopleLeavingPerMin: 5,
          movementSpeed: 1.5,
          flowDirection: 'Entering',
        },
      ],
      entryGates: [{ id: 'gate-1', capacity: 100, occupancy: 5, queueLength: 0, waitTime: 0 }],
      exitGates: [],
    };
